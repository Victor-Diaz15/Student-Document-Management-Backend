...
public class AddStudentFileCommandValidator : AbstractValidator<AddStudentFileCommand>
{
    private readonly FileUploadSettings _fileUploadSettings;

    public AddStudentFileCommandValidator(IOptions<FileUploadSettings> fileUploadSettings)
    {
